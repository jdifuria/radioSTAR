...
users = User.create(
  [
    { email: 'a@a.com', name: "Mrs. Aardvark",   password: "a", password_confirmation: "a", compliance: 10, station_id: 1},
    { email: 'b@b.com', name: "Mrs. Bear",       password: "b", password_confirmation: "b", compliance: 15.1, station_id: 2},
    { email: 'c@c.com', name: "Mrs. Cat",        password: "c", password_confirmation: "c", compliance: 22.12, station_id: 3},
    { email: 'd@d.com', name: "Mrs. Dog",        password: "d", password_confirmation: "d", compliance: 24, station_id: 4},
    { email: 'e@e.com', name: "Mrs. Elephant",   password: "e", password_confirmation: "e", compliance: 30.123, station_id: 1},
    { email: 'f@f.com', name: "Mrs. Fox",        password: "f", password_confirmation: "f", compliance: 40.123, station_id: 1},
    { email: 'g@g.com', name: "Mrs. Gopher",     password: "g", password_confirmation: "g", compliance: 50.12345, station_id: 1},
    { email: 'h@h.com', name: "Mrs. Horse",      password: "h", password_confirmation: "h", compliance: 50, station_id: 1},
    { email: 'i@i.com', name: "Mrs. Iguana",     password: "i", password_confirmation: "i", compliance: 60.123456, station_id: 1},
    { email: 'j@j.com', name: "Mrs. Jackrabbit", password: "j", password_confirmation: "j", compliance: 60, station_id: 1},
    { email: 'k@k.com', name: "Mrs. Kangaroo",   password: "k", password_confirmation: "k", compliance: 100, station_id: 1},
    { email: 'l@l.com', name: "Mrs. Lama",       password: "l", password_confirmation: "l", compliance: 100, station_id: 1},
    { email: 'm@m.com', name: "Mrs. Mouse",      password: "m", password_confirmation: "m", compliance: 100, station_id: 1},
    { email: 'n@n.com', name: "Mrs. Numbat",     password: "n", password_confirmation: "n", compliance: 100, station_id: 1},
    { email: 'o@o.com', name: "Mrs. Opossum",    password: "o", password_confirmation: "o", compliance: 100, station_id: 1},
    { email: 'p@p.com', name: "Mrs. Peacock",    password: "p", password_confirmation: "p", compliance: 100, station_id: 1},
    { email: 'q@q.com', name: "Mrs. Quail",      password: "q", password_confirmation: "q", compliance: 100, station_id: 1},
    { email: 'r@r.com', name: "Mrs. Rabbit",     password: "r", password_confirmation: "r", compliance: 100, station_id: 1},
    { email: 's@s.com', name: "Mrs. Snake",      password: "s", password_confirmation: "s", compliance: 100, station_id: 1},
    { email: 't@t.com', name: "Mrs. Tiger",      password: "t", password_confirmation: "t", compliance: 100, station_id: 1},
    { email: 'u@u.com', name: "Mrs. Urial",      password: "u", password_confirmation: "u", compliance: 100, station_id: 1},
    { email: 'v@v.com', name: "Mrs. Vulture",    password: "v", password_confirmation: "v", compliance: 100, station_id: 1},
    { email: 'w@w.com', name: "Mrs. Wombat",     password: "w", password_confirmation: "w", compliance: 100, station_id: 1},
    { email: 'x@x.com', name: "Mrs. Xerox",      password: "x", password_confirmation: "x", compliance: 100, station_id: 1},
    { email: 'y@y.com', name: "Mrs. Yak",        password: "y", password_confirmation: "y", compliance: 100, station_id: 1},
    { email: 'z@z.com', name: "Mrs. Zebra",      password: "z", password_confirmation: "z", compliance: 100, station_id: 1},
