...
class ChartsControllerTest < ActionController::TestCase
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post :create, chart: { country: @chart.country, date: @chart.date, name: @chart.name, source_url: @chart.source_url }
    end
  ...
  test "should update chart" do
    patch :update, id: @chart, chart: { country: @chart.country, date: @chart.date, name: @chart.name, source_url: @chart.source_url }
    assert_redirected_to chart_path(assigns(:chart))
  end
