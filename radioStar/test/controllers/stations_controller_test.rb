...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { station_id: @station.station_id, station_name: @station.station_name, station_url: @station.station_url, user_id: @station.user_id }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { station_id: @station.station_id, station_name: @station.station_name, station_url: @station.station_url, user_id: @station.user_id }
    assert_redirected_to station_path(assigns(:station))
  end
